...
@if ($variants->count())
    <form action="{{ route('cart.add') }}" method="POST" class="mt-3" id="variantForm">
        ...
        <button type="submit" class="btn btn-dark ms-3" style="margin-top: 20px">🛒 Thêm vào giỏ hàng</button>
    </form>
    <div class="mt-2">
                    ...
                    <div class="card text-center h-100">
                        <a href="{{ route('client.product.detail', $item->id) }}" class="text-decoration-none text-dark">
                            ...
                            <div class="card-body">
                                ...
                                <button type="submit" class="btn-add-to-cart" title="Thêm vào giỏ hàng">🛒</button>
                            </div>
                        </a>
                    </div>
                </div>
