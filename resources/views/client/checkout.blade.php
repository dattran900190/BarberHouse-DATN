        ...
        <section class="h-100 h-custom">
            <div class="mainCheckout">
                ...
                <div class="informationProduct">
                    ...
                    <div class="form-check" style="display: flex; justify-content: space-between">
                        <div class="chon">
                            <input class="form-check-input" value="1" type="radio" name="phuong_thuc_thanh_toan_id"
                                checked />
                ...
                <div class="informationProduct">
                    ...
                    <div class="dat-hang">
                        <a href=""><i class="fa-solid fa-angle-left"></i> Quay về giỏ hàng</a>
                        <button class="btn btn-info" type="submit" style="padding: 10px 20px">
                            ĐẶT HÀNG
                        </button>
                    </div>
                </div>
