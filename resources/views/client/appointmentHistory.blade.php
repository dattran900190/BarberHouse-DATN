        ...
        <div class="card-body">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3 text-center">
                        <div class="d-flex justify-content-center">
                            <a class="btn btn-outline-primary btn-sm" href="{{ route('client.detailAppointmentHistory') }}">Xem chi tiết</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="order-item mb-3 p-3 rounded-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3 text-center">
                        <div class="d-flex justify-content-center">
                            <a class="btn btn-outline-primary btn-sm me-1" href="{{ route('client.detailAppointmentHistory') }}">Xem chi tiết</a>
                            <a class="btn btn-outline-danger btn-sm" href="#" title="Hủy đặt lịch">Hủy đặt lịch</a>
                        </div>
                    </div>
                </div>
            </div>
