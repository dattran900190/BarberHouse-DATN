  ...
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-center align-items-center w-100">
      ...
      <ul class="navbar-nav d-flex flex-row flex-nowrap ms-4">
        ...
        <li class="nav-item mx-2"><a class="nav-link" href="{{ url('cart') }}"><i class="fa-solid fa-cart-shopping"></i></a></li>
        <li class="nav-item mx-2"><a class="nav-link" href="#"><i class="fa-brands fa-facebook"></i></a></li>
        <li class="nav-item mx-2"><a class="nav-link" href="#"><i class="fa-brands fa-instagram"></i></a></li>
        <li class="nav-item mx-2"><a class="nav-link" href="#"><i class="fa-brands fa-youtube"></i></a></li>
        <li class="nav-item dropdown mx-2">
          <a class="nav-link" href="#" id="accountDropdown"
