            ...
            @foreach ($appointments as $index => $appointment)
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        @include('admin.appointments.partial._actions', ['appointment' => $appointment, 'type' => $type])
                    </td>
                </tr>
            @endforeach
        @else
            <tr>
                <td colspan="{{ $type === 'cancelled' ? 11 : 10 }}" class="text-center text-muted">Không có lịch hẹn nào phù hợp.</td>
            </tr>
        @endif
    </tbody>
</table>