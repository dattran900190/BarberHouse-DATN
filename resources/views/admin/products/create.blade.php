...
<div class="container-fluid px-0">
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="price" id="price" class="form-control w-100" step="0.01" value="{{ old('price') }}">
        ...
        <div class="mb-3">
            ...
            <input type="file" name="additional_images[]" id="additional_images" class="form-control w-100" multiple accept="image/jpeg,image/png,image/jpg">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <select name="variants[{{ $index }}][volume_id]" class="form-control w-100">
                                ...
                                @foreach ($volumes as $volume)
                                    <option value="{{ $volume->id }}" {{ (string)($variant['volume_id'] ?? '') === (string)$volume->id ? 'selected' : '' }}>
                                        {{ $volume->name }}
                                    </option>
                                @endforeach
                            </select>
